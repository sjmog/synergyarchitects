# WordPress theme information is stored in source/assets/stylesheets/_header.scss as of Forge version 0.5
...
require 'sassy-buttons' #gem install sassy-buttons